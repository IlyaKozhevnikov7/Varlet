...
bool ImGui::CheckboxFlagsT(const char* label, Size* flags, Size flags_value)
{
...
template<typename Size>
static int DataTypeCompareT(const Size* lhs, const Size* rhs)
{
    if (*lhs < *rhs) return -1;
    if (*lhs > *rhs) return +1;
    return 0;
...
template<typename Size>
static bool DataTypeClampT(Size* v, const Size* v_min, const Size* v_max)
{
